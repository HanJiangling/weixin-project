...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <link type="text/css" href="/static/Home/xiangmv/css/optstyle.css" rel="stylesheet" />
    <link type="text/css" href="/static/Home/xiangmv/css/style.css" rel="stylesheet" />

    <script type="text/javascript" src="/static/Home/xiangmv/basic/js/jquery-1.7.min.js"></script>
    <script type="text/javascript" src="/static/Home/xiangmv/basic/js/quick_links.js"></script>

    <script type="text/javascript" src="/static/Home/xiangmv/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
    <script type="text/javascript" src="/static/Home/xiangmv/js/jquery.imagezoom.min.js"></script>
    <script type="text/javascript" src="/static/Home/xiangmv/js/jquery.flexslider.js"></script>
    <script type="text/javascript" src="/static/Home/xiangmv/js/list.js"></script>
        ...
        <div class="scoll">
          <section class="slider">
            <div class="flexslider">
              <ul class="slides">
                <li>
                  <img src="/static/Home/xiangmv/images/01.jpg" title="pic" />
                </li>
                <li>
                  <img src="/static/Home/xiangmv/images/02.jpg" />
                </li>
                <li>
                  <img src="/static/Home/xiangmv/images/03.jpg" />
                </li>
              </ul>
            </div>
          </section>
          ...
          <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
              ...
              <ul class="tb-thumb" id="thumblist">
                ...
                <li>
                  <div class="tb-pic tb-s40">
                    <a href="#"><img src="/static/Home/xiangmv/images/02_small.jpg" mid="/static/Home/xiangmv/images/02_mid.jpg" big="/static/Home/xiangmv/images/02.jpg"></a>
                  </div>
                </li>
                <li>
                  <div class="tb-pic tb-s40">
                    <a href="#"><img src="/static/Home/xiangmv/images/03_small.jpg" mid="/static/Home/xiangmv/images/03_mid.jpg" big="/static/Home/xiangmv/images/03.jpg"></a>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="tb-detail-list">
              ...
              <div class="tb-detail-price">
                <li class="price iteminfo_mktprice">
                  <dt>价格</dt>
                  <dd><em>¥</em><b class="sys_item_mktprice">{{$shop->price}}</b></dd>                 
                </li>
                <div class="clear"></div>
              </div>
              <div class="clear"></div>
                    ...
                    <div class="theme-popbod dform">
                      <form class="theme-signin" name="loginform" action="/homecart" method="post">
                        ...
                        <div class="theme-signin-right">
                          <div class="img-info">
                            <img src="/static/Home/xiangmv/images/songzi.jpg" />
                          </div>
                        </div>
        ...
        <div class="match">
          ...
          <div class="match-comment">
            <ul class="like_list">
              <li>
                <div class="s_picBox">
                  <a class="s_pic" href="#"><img src="/static/Home/xiangmv/images/cp.jpg"></a>
              ...
              <li>
                <div class="s_picBox">
                  <a class="s_pic" href="#"><img src="/static/Home/xiangmv/images/cp2.jpg"></a>
              ...
              <div class="mc"> 
                 <ul>             
                  <div class="mt">            
                    ...
                    <li class="first">
                      <div class="p-img">                    
                        <a  href="#"> <img class="" src="/static/Home/xiangmv/images/browse1.jpg"> </a>               
                      </div>
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                  ...
                  <div class="details">
                    ...
                    <div class="twlistNews">
                      <img src="/static/Home/xiangmv/images/tw1.jpg" />
                      <img src="/static/Home/xiangmv/images/tw2.jpg" />
                      <img src="/static/Home/xiangmv/images/tw3.jpg" />
                      <img src="/static/Home/xiangmv/images/tw4.jpg" />
                      <img src="/static/Home/xiangmv/images/tw5.jpg" />
                      <img src="/static/Home/xiangmv/images/tw6.jpg" />
                      <img src="/static/Home/xiangmv/images/tw7.jpg" />
                    </div>
                  </div>
                  <div class="clear"></div>
                ...
                <div class="am-tab-panel am-fade">
                  ...
                  <ul class="am-comments-list am-comments-list-flip">
                    <li class="am-comment">
                      <!-- 评论容器 -->
                      <a href="">
                        <img class="am-comment-avatar" src="/static/Home/xiangmv/images/hwbn40x40.jpg" />
                        <!-- 评论者头像 -->
                      </a>
                    ...
                    <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                      <li>
                        <div class="i-pic limit">
                          <img src="/static/Home/xiangmv/images/imgsearch1.jpg" />
        ...
        <div id="sidebar">
          <div id="wrap">
            ...
            <div id="brand" class="item">
              <a href="#">
                <span class="wdsc"><img src="/static/Home/xiangmv/images/wdsc.png" /></span>
              </a>
              <div class="mp_tooltip">
                我的收藏
                <i class="icon_arrow_right_black"></i>
            ...
            <div id="broadcast" class="item">
              <a href="#">
                <span class="chongzhi"><img src="/static/Home/xiangmv/images/chongzhi.png" /></span>
              </a>
              <div class="mp_tooltip">
                我要充值
                <i class="icon_arrow_right_black"></i>
            ...
            <div class="quick_toggle">
              ...
              <li class="qtitem">
                ...
                <div class="mp_qrcode" style="display:none;"><img src="/static/Home/xiangmv/images/weixin_code_145.png" /><i class="icon_arrow_white"></i></div>
              </li>
              <li class="qtitem">
