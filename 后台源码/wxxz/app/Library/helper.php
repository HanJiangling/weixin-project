...
function sendsphone($p){
	...
	$options['accountsid']='174258f9736a51b061ace9769c97a109';
	//填写在开发者控制台首页上的Auth Token
	$options['token']='7820218ce7f753673567d5c9cca90256';

	//初始化 $options必填
	$ucpass = new Ucpaas($options);
	$appid = "15f0a460269b4b47aeb96df4c466ec5a";	//应用的ID，可在开发者控制台内的短信产品下查看
	$templateid = "545572";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
	//要发送的校验码
